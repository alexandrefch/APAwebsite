...
final class Version20210519130554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contributor (id INT AUTO_INCREMENT NOT NULL, user_profil_id INT NOT NULL, UNIQUE INDEX UNIQ_DA6F979327BE5D9C (user_profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE doctor (id INT AUTO_INCREMENT NOT NULL, user_profil_id INT NOT NULL, UNIQUE INDEX UNIQ_1FC0F36A27BE5D9C (user_profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, user_profil_id INT NOT NULL, UNIQUE INDEX UNIQ_1ADAD7EB27BE5D9C (user_profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE doctor ADD CONSTRAINT FK_1FC0F36A27BE5D9C FOREIGN KEY (user_profil_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB27BE5D9C FOREIGN KEY (user_profil_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contributor DROP FOREIGN KEY FK_DA6F979327BE5D9C');
        $this->addSql('ALTER TABLE doctor DROP FOREIGN KEY FK_1FC0F36A27BE5D9C');
        $this->addSql('ALTER TABLE patient DROP FOREIGN KEY FK_1ADAD7EB27BE5D9C');
